...
export default function SurveyPage() {
  ...
  const [backgroundImage, setBackgroundImage] = useState("/mountains.jpg"); // Fallback image

  useEffect(() => {
    if (city) fetchSurveyQuestions();

    // Retrieve the background image from localStorage
  ...
  // Get city name with first letter capitalized
  ...
  const getQuestionCategory = (question: string): string => {
    ...
    if (
      ...
      lowercaseQuestion.includes("restaurant") ||
      lowercaseQuestion.includes("eat") ||
      lowercaseQuestion.includes("cuisine")
    ) {
      return "food";
      ...
      lowercaseQuestion.includes("spend")
    ) {
      return "budget";
    } else if (
      lowercaseQuestion.includes("comfort") ||
      lowercaseQuestion.includes("luxury") ||
      lowercaseQuestion.includes("accommodation") ||
      lowercaseQuestion.includes("hotel")
    ) {
      return "comfort";
    } else if (
      lowercaseQuestion.includes("transport") ||
      lowercaseQuestion.includes("travel") ||
      lowercaseQuestion.includes("getting around")
    ) {
      return "transportation";
    } else if (
      lowercaseQuestion.includes("sightseeing") ||
      lowercaseQuestion.includes("landmark") ||
      lowercaseQuestion.includes("attraction")
    ) {
      return "sightseeing";
    } else if (
      lowercaseQuestion.includes("adventure") ||
      lowercaseQuestion.includes("outdoor") ||
      lowercaseQuestion.includes("hiking") ||
      lowercaseQuestion.includes("extreme")
    ) {
      return "adventure";
  ...
  // Function to get question-related icon with animation
  const getQuestionIcon = (question: string) => {
    const category = getQuestionCategory(question);

    // Animation variations for different categories
    const iconVariants = {
      food: {
    ...
    // Icons based on question category
    switch (category) {
      case "food":
        return (
          <motion.div
          ...
          >
            <svg className="w-12 h-12 text-teal-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path
                d="M18 8h1a4 4 0 0 1 0 8h-1M5 8h11v9a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4V8z"
                strokeLinecap="round"
      ...
      case "activities":
        return (
          ...
          >
            <svg className="w-12 h-12 text-teal-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path
                d="M14 22h5a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2h-5M9 16V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h3a2 2 0 0 0 2-2z"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
        ...
        return (
          ...
          >
            <svg className="w-12 h-12 text-teal-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <path
                d="M16 8H8M6 21h12M7 16H4a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h3M17 16h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-3"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
            </svg>
        ...
        return (
          ...
          >
            <svg className="w-12 h-12 text-teal-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <path
                d="M20.188 10.9A8.18 8.18 0 0 0 17.77 6.78a8.06 8.06 0 0 0-9.54 0 8.18 8.18 0 0 0-2.4 4.15A8.15 8.15 0 0 0 5.8 11 8.17 8.17 0 0 0 6.82 16a8.07 8.07 0 0 0 2.96 2.96 8.08 8.08 0 0 0 10.45-2.97 8.17 8.17 0 0 0 1-5.10 8.15 8.15 0 0 0-1.03.01z"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M17.5 6.5l.5 .5M6.5 6.5l-.5 .5M6.5 17.5l-.5 -.5M17.5 17.5l.5 -.5M12 2.5v2M12 19.5v2M2.5 12h2M19.5 12h2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
            </svg>
  ...
  // Function to get loader animation based on question content
  ...
  // Function to get option animations based on question category
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[300px]">
          {loading && questions.length > 0 && currentQuestionIndex < questions.length ? (
            getQuestionLoader(questions[currentQuestionIndex].question)
          ) : (
            <div className="w-16 h-16 border-4 border-teal-400 border-t-transparent rounded-full animate-spin"></div>
          )}
        </div>
              ...
              <motion.div
                ...
                className={`p-4 border rounded-lg cursor-pointer transition-colors ${
                  selectedAnswers[currentQuestion.question] === option
                    ...
                    : "bg-gray-800 border-gray-200 hover:border-teal-300"
                }`}
                ...
                transition={{
                  ...optionAnimationVariants.transition,
  ...
  return (
    <div
      className="min-h-screen bg-gray-900 py-10 px-4 bg-cover bg-center"
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-lg transition-colors ${
              currentQuestionIndex === 0
                ...
                : "bg-gray-700 border border-teal-400 text-teal-300 hover:bg-teal-600"
            }`}
          >
            Previous
          </button>
